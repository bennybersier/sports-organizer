...
export const AUDIT_ACTIONS = {
  ...
  /* The whole season's matches planned in one go, so it is worth one line. */
  ...
  SCHEDULE_ENTRY_RESTORED: "SCHEDULE_ENTRY_RESTORED",
  SCHEDULE_SERIES_CANCELLED: "SCHEDULE_SERIES_CANCELLED",
  SCHEDULE_SERIES_RESTORED: "SCHEDULE_SERIES_RESTORED",
  SCHEDULE_WITHDRAWN: "SCHEDULE_WITHDRAWN",
  ...
  REGISTER_CANCELLED: "REGISTER_CANCELLED",
  REGISTER_REOPENED: "REGISTER_REOPENED",
  ABSENCE_DECLARED: "ABSENCE_DECLARED",
  BOX_SCORE_RECORDED: "BOX_SCORE_RECORDED",
  EVALUATION_WRITTEN: "EVALUATION_WRITTEN",
